...
# Validate 'Thank you for registering'
# email is sent to the registered email address as a confirmation for registering the account
# TC_RF_002

def test_TC_RF_002(setup):
    ...
    if actual_result == expected:
        ...
        driver.save_screenshot(os.path.abspath(os.path.join(os.getcwd(), os.pardir,os.pardir)) + '\\screenshots\\' + 'test_TC_RF_002.png')
        assert False
