...
def test_TC_RF_006(setup):
    ...
    print(actual_result)
    expected_result = "Subscribe / unsubscribe to newsleetter"

    if actual_result == expected_result:
        assert True
    else:
        driver.save_screenshot(
            os.path.abspath(os.path.join(os.getcwd(), os.pardir, os.pardir)) + '\\screenshots\\' + 'test_TC_RF_006.png')
        assert False